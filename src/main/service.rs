...
use common::{Context, Core, CoreMessage, Priority};
...
use main::peer_id;
use main::{Bootstrap, Connect, ConnectionListener, ConnectionMap, CrustError, Event, PeerId};
...
mod tests {
    ...
    fn connect(service_0: &Service,
        ...
        expect_event!(event_rx_0, Event::NewPeer(res) => {
            assert_eq!(unwrap_result!(res), service_1.id());
        });
